            ...
            <div
                ...
                <div
                    ...
                    <div className="h-52 relative z-10">
                        <div
                            className="h-full flex flex-col space-y-6 transition-all duration-500 justify-center items-center text-center">
                            <div><h3 className="text-lg font-semibold mb-2">How to use</h3></div>
                            <Link href={"/HowToUse"}>
                                <button
                                    className="p-3 px-4 py-2 bg-white/20 hover:bg-white/30 rounded-lg text-sm font-medium transition-all duration-500 border border-white/30">
                                    使い方を見る
                                </button>
                            </Link>
                        </div>
